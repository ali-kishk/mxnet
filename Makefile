...
WARNFLAGS= -Wall -Wsign-compare -Wno-deprecated-declarations
...
CFLAGS += -I$(ROOTDIR)/mshadow/ -I$(ROOTDIR)/dmlc-core/include -fPIC -I$(NNVM_PATH)/include -I$(VEXCL_PATH) -Iinclude $(MSHADOW_CFLAGS)
